...
from .views import RegisterView, CheckCNPJView, LoginView, LojaDeleteView, LojaCreateView, LojaListView, LojaDetailUpdateAPIView, LojaDetailAPIView, TecnicoDeleteView, TecnicoCreateView, TecnicoListView, TecnicoDetailUpdateAPIView, TecnicoDetailAPIView
...
urlpatterns = [
    ...
    path('tecnico/check-cnpj/', CheckCNPJView.as_view(), name='check_cnpj'),
